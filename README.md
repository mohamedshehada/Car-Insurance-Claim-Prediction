...
### Insight
The 16–25 age group shows the highest claim count among claimants, consistent with inexperienced drivers taking more risks on the road.
...
### Insight
CREDIT_SCORE (−0.33) and VEHICLE_OWNERSHIP (−0.38) show the strongest negative correlations with OUTCOME. SPEEDING_VIOLATIONS and PAST_ACCIDENTS are positively correlated with each other (0.44) and with claim risk.
